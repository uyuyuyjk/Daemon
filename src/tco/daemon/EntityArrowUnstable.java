...
//majority of code from EntityArrow
public class EntityArrowUnstable extends Entity
{
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	...
	public EntityArrowUnstable(World par1World)
	{
		super(par1World);
		this.setSize(0.5F, 0.5F);
	}

	public EntityArrowUnstable(World par1World, EntityLiving par2EntityLiving, float par3)
	{
		super(par1World);
	...
	public void onUpdate(){
		...
		if(inGround){
			for (int i = 0; i < 32; ++i) {
				worldObj.spawnParticle("portal", posX, posY
						+ rand.nextDouble() * 2.0D, posZ,
